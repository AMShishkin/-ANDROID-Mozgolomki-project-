package com.example.ams.golovolomki.apprater;
...
import com.example.ams.golovolomki.Activities.MainActivity;
...
public class AppRater {
    ...
    private static int DAYS_UNTIL_PROMPT_FOR_REMIND_LATER = 2;
        ...
        builder.setPositiveButton(context.getString(R.string.apprater_rate),
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        MainActivity.bdh.UpdateSettingsRate(MainActivity.db, 1, "true");
        ...
        builder.setNeutralButton(context.getString(R.string.apprater_later),
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        MainActivity.bdh.UpdateSettingsToNextRate(MainActivity.db, 1, "" + (Integer.parseInt(DatabaseHelper.settingsCursor.getString(2)) + 3));
                        MainActivity.db.close();
